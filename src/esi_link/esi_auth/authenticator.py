...
#         self, params: AuthenticationRequestParams, timeout: int = 300
#     ) -> CharacterToken:
...
#             ClientResponseError: If the revocation request fails with a non-200 status code.
...
#         # TODO: Consider starting in another thread or process to avoid blocking the main event loop.
#         app = web.Application()

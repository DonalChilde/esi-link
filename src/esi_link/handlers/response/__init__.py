...
from esi_link.handlers.response.response_data_file_saver import (
    ResponseDataFileSaverResponseHandler,
)
...
builtin_response_handlers: dict[str, type[ResponseHandlerProtocol]] = {
    ...
    ResponseDataFileSaverResponseHandler.name: ResponseDataFileSaverResponseHandler,
}
